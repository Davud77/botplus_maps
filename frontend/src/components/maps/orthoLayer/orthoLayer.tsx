// src/components/maps/orthoLayer/orthoLayer.tsx
...
interface OrthoLayerProps {
  toggleOrthoLayer: (newOrthoImages: OrthoImageType[]) => void;
}
...
const OrthoLayer: React.FC<OrthoLayerProps> = ({ toggleOrthoLayer }) => {
  ...
  return (
    <button
      ...
      onClick={() => toggleOrthoLayer(orthoImages)}
      style={{ position: 'absolute', top: '210px', right: '14px', zIndex: 1000 }}
    >
